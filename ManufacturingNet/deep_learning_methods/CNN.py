  ...
  def get_number_classes(self): # get number of classes
    ...
    while gate!=1:
      ...
      if (self.num_classes.isnumeric() and int(self.num_classes) > 0):
        ...
        gate = 0
        print("Please enter valid number of classes.  The value must be an integer and greater than zero")
...
class CNNModel(object):
    ...
    def __init__(self,X,Y, shuffle = True):
        ...
        self.net = CNN2D(CNNBlock).double()           # building a network architecture
    ...
    def _get_batchsize_input(self):
        ...
        while gate!= 1:
            ...
            if self.batchsize.isnumeric() and int(self.batchsize) >0 :
                ...
                print('Please enter a valid numeric input. The value must be an integer and greater than zero')
  ...
  # def __init__(self, net, criterion=nn.CrossEntropyLoss(),lr=0.001,batch_size =32,weight_decay=0.001,gpu=False):
  #   self.net = net
  ...
  #             loss = self.criterion(outputs, target.long()).detach()
  #             running_loss += loss.item()
