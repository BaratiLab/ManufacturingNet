    ...
    def get_pretrained_model(self):
        ...
        while gate!=1:
            ...
            if (1<= self.model_select <=4):
                ...
                print('Please enter valid input')
        model.features[0]=nn.Conv2d(self.train_data[0][0].shape[0], 64, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1), bias=False)


        model.classifier[-1]=nn.Linear(4096,self.num_classes,bias=True)
